#  07 - Funciones de Cadena y Transact
...
-- Funcion LEFT
-- Extrae un n�mero espec�fico de caracteres desde el incio de la cadena
SELECT LEFT(@texto, 4) as Inicio
-- Funci�n RIGHT
-- Extrae un n�mero determinado de caracteres del final de la cadena
...
-- SUBSTRING -> Extrae una parte de la cadena, donde el segundo parametro es la posici�n inicial
-- y el tercer par�metro el recorrido
