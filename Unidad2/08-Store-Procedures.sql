...
EXECUTE SP_InfoVentas2 'Berglunds Snabbköp', '07-04-1996', '01-01-1997'
GO
...
-- SP con parámetros en diferente posición
...
EXECUTE SP_InfoVentas2 @fecha2 = '01-01-1997', @nombre = 'Berglunds Snabbköp', @fecha1 = '07-04-1996'
...
--Crear un SP que permita saber si un alumno aprobó o reprobó
...
BEGIN
	...
	BEGIN
		if @calif >= 8
		print 'La califiación es aprobatoria'
		else
		print 'La calificación es reprobatoria'
	END
	else print 'Calificación no válida'
END;
GO
...
--- Crear un SP que permita verififcar si un cliente existe antes de devolver su información
...
BEGIN
    ...
    WHILE (@i <= @num)
    BEGIN
        PRINT 'El valor número ' + CAST(@i AS VARCHAR(10))
        SET @i = @i + 1
    END
END
GO
